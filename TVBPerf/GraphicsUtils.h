...
public:
	...
	static void create_buffer(ComPtr<ID3D12Resource>& buffer, ID3D12Device* p_device, UINT64 width, UINT64 height, D3D12_HEAP_TYPE heap_type, D3D12_RESOURCE_STATES state);
