...
namespace rndr {
    ...
    void RendererTVB::create_dsv_heap() {
    ...
    void RendererTVB::create_depth_stencil_buffer() {
    ...
    void RendererTVB::create_rtv_heap() {
        D3D12_DESCRIPTOR_HEAP_DESC rtv_heap_desc{};
        rtv_heap_desc.NumDescriptors = FRAME_COUNT + 1;
    ...
    void RendererTVB::create_render_targets() {
        D3D12_CPU_DESCRIPTOR_HANDLE rtv_handle =
            rtv_heap_->GetCPUDescriptorHandleForHeapStart();
    ...
    void RendererTVB::create_srv_heap() {
        ...
        srv_heap_desc.NumDescriptors = 6 + program_arguments_->texture_count;
