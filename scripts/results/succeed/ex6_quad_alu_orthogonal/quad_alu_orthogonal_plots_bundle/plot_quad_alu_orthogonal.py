...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("quad_alu_orthogonal_plots"),
    )
    ...
    quad_values, alu_values, grids, _, repeat_grid = build_grid(rows)
    ...
    models = fit_interaction_models(quad_values, alu_values, grids)
